...
=================================================
+ Moved to VS2022 and WTL10
+ Removed code for updater and setup
+ Fixed issue with spurious dragdrop events when running in wine on kde plasma
+ Improved dragdrop icon
